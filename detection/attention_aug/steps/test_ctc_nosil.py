...
parser.add_argument('--conf', help='conf file for training', default='conf/ctc_config.yaml')
...
def test():
    ...
    with torch.no_grad():
        for data in test_loader:
            ...
            targets, target_sizes = trans_.numpy(), trans_sizes_.numpy()
