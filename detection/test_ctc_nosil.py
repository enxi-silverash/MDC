...
from data_loader import Vocab, SpeechDataset, SpeechDataLoader
...
def test():
    ...
    model_path = "ctc_best_model_24.pkl"
    # model_path = os.path.join(checkpoint_dir, opts.exp_name, 'ctc_best_model.pkl')
    ...
    start = time.time()
    with torch.no_grad():
        for data in test_loader:  # 就是一句对应一句
