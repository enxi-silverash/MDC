...
import random
from detection.tools import load_wave, F_Mel, make_context, skip_feat, spec_augment, data_enhancement
    ...
    def process_feature_label(self):
        ...
        with open(self.scp_path, 'r') as rf:
            ...
            while line:
                ...
                # path="fbank.ark"
                print(path.split("."))
                path='./detection/fbank.'+path.split(".")[2]
                print(path)
        ...
        self.item = []
        print(path,utt,label_dict,trans_dict,path_dict)
